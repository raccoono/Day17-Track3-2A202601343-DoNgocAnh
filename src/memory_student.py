...
class StudentMemory:
    ...
    def retrieve_long_term(self, user_id: str, thread_id: str, query: str) -> str:
        ...
        # Keep the fallback scoped to this user's graph. Edge search makes
        # deadline/open-loop evidence and its validity range explicit, while a
        # search failure must not discard the Context Block returned above.
        try:
